...
const DUMMY_BUDGETS: BudgetCategory[] = [
  { id: '1', name: 'Living Room', itemCount: 2, amount: 450, icon: 'sofa', color: '#6A1B9A' },
  { id: '2', name: 'Bathroom', itemCount: 1, amount: 700, icon: 'bathtub', color: '#00C853' },
  { id: '3', name: 'Travel', itemCount: 0, amount: 2000, icon: 'beach', color: '#FF7043' },
];

const BudgetsScreen: React.FC = () => {
  const totalEstimate = DUMMY_BUDGETS.reduce((sum, item) => sum + item.amount, 0);
