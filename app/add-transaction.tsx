...
const AddTransactionScreen: React.FC = () => {
  ...
  const [category, setCategory] = useState({ name: 'Select Category', icon: 'shape-plus' });
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.inputGroup}>
          ...
          <TouchableOpacity style={styles.categorySelector} onPress={handleSelectCategory}>
            <View style={styles.categoryLeft}>
              <View style={styles.iconBg}>
                <MaterialCommunityIcons name={category.icon as any} size={20} color={COLORS.textPrimary} />
              </View>
      ...
      <View style={styles.footer}>
        <PrimaryButton 
          ...
          onPress={handleSave} 
          style={{ backgroundColor: type === 'Expense' ? COLORS.textPrimary : COLORS.income }}
