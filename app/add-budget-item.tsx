...
import { View, StyleSheet, SafeAreaView, StatusBar, TextInput, ScrollView, Alert } from 'react-native';
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.form}>
            ...
            {/* Url */}
            <View style={styles.inputContainer}>
                <MaterialCommunityIcons name="link" size={24} color={COLORS.textSecondary} style={styles.icon} />
                <TextInput
                    style={styles.input}
                    placeholder="Url"
                    value={url}
            ...
            {/* Note */}
            <View style={styles.inputContainer}>
                <MaterialCommunityIcons name="pencil-outline" size={24} color={COLORS.textSecondary} style={styles.icon} />
                <TextInput
                    style={styles.input}
                    placeholder="Note"
                    value={note}
