...
const DUMMY_WALLETS: Wallet[] = [
  { id: "1", name: "Side hustle", balance: 70.0, icon: "piggy-bank" },
  { id: "2", name: "Freelancing", balance: 335.0, icon: "laptop" },
  { id: "3", name: "Salary", balance: 79.0, icon: "office-building" },
  { id: "4", name: "Investments", balance: 1200.5, icon: "chart-line" },
];

const WalletsScreen: React.FC = () => {
  const totalBalance = DUMMY_WALLETS.reduce(
